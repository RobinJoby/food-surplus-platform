...
import { Clock, User, MessageSquare, CheckCircle, XCircle, Package2 } from 'lucide-react'
...
const PickupRequestCard = ({ request, onAction, type = 'donor' }) => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-2xl border border-gray-200 hover:border-primary-300 transition-all duration-300 hover:shadow-xl hover:scale-[1.01] p-6">
            <div className="flex items-start justify-between">
                <div className="flex-1 space-y-3">
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-2">
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-bold ${getStatusBadgeClass(request.status)}`}>
