...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white bg-opacity-90 shadow-2xl border-b border-gray-200 transition-colors duration-700 sticky top-0 z-50 backdrop-blur-sm">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-3 px-4 py-2 rounded-lg font-medium text-gray-700 hover:bg-white hover:bg-opacity-20 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-400"
              >
